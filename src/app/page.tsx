    ...
    return (
      <div className="min-h-screen bg-white">
        <nav className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto border-b border-gray-100">
          ...
          <button onClick={() => setMode('login')} className="bg-salmon-400 text-white px-5 py-2 rounded-lg font-medium hover:bg-salmon-500 transition-colors">Iniciar Sesión</button>
        </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-6 text-lg text-gray-500 max-w-lg">
                Dra. Claudia Anahí Hernández Carrillo — Psiquiatra. Gestiona tus citas, recetas y pagos desde una plataforma segura.
              </p>
              <div className="mt-10 flex gap-4">
                <button onClick={() => setMode('login')} className="bg-salmon-400 text-white px-8 py-3.5 rounded-xl font-semibold text-lg hover:bg-salmon-500 transition-colors shadow-lg shadow-salmon-200">
                  Iniciar Sesión
                </button>
              </div>
              <p className="mt-4 text-sm text-gray-400">Si eres paciente nuevo, solicita un enlace de invitación a tu doctora.</p>
            </div>
    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="card border border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900 text-center mb-6">Iniciar Sesión</h2>
          ...
          <p className="text-center text-xs text-gray-400 mt-4">Si eres paciente nuevo, solicita un enlace de invitación a tu doctora.</p>
        </div>
